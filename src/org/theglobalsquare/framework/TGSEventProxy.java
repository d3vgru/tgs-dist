...
public class TGSEventProxy {
	...
	private Map<Class<? extends TGSEvent<? extends TGSObject>>, Set<PropertyChangeListener>> listeners;
	private Queue<TGSEvent<? extends TGSObject>> qToPy;
	private TGSEventProxy() {
		listeners = new HashMap<Class<? extends TGSEvent<? extends TGSObject>>, Set<PropertyChangeListener>>();
	...
	public static void addListener(Class<? extends TGSEvent<? extends TGSObject>> c, PropertyChangeListener l) {
	...
	public static boolean sendEvent(TGSEvent e, boolean toPy) {
		...
		for(Class<? extends TGSEvent<? extends TGSObject>> c : proxy.listeners.keySet()) {
